...
# ============================================================
# AMAZON BEDROCK RUNTIME DEFAULTS
# ============================================================
...
# The standard Bedrock Runtime Boto3 client is created on demand from the
...
"""
    ...
    try:
        response = client.converse(
            modelId=model_id,
            system=[
                {"text": "Return only a person name or Not found. No explanation."}
            ],
            messages=[
                {
                    "role": "user",
                    "content": [{"text": mini_prompt}],
                },
            ],
            inferenceConfig={
        ...
        name = extract_bedrock_text(response).strip()
...
# ============================================================
# AMAZON BEDROCK RUNTIME REASONING
# ============================================================
